...
package org.tgaudioplayer.app.lib.swingx;
...
//                buffer.setColor(new Color(0.0f, 0.0f, 0.0f, shadowOpacity));
    ...
    */
    ...
    public Insets getBorderInsets(Component c) {
        int top = showTopShadow ? shadowSize : shadowSize / 2;
        int left = showLeftShadow ? shadowSize : shadowSize / 2;
        int bottom = showBottomShadow ? shadowSize : shadowSize / 2;
        int right = showRightShadow ? shadowSize : shadowSize / 2;
